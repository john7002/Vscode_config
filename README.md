...
| `CTRL-V` (select lines) + I      |      Insert at the beginning of every lines selected           | 	Mode normal de Vim
| `CTRL-V` (select lines) + $A      |      Insert at the end of every lines selected           | 	Mode normal de Vim
